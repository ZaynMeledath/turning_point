...
import 'package:turning_point/view/contest/contest_details_screen.dart';

Widget contestCardInnerContainer({required BuildContext context}) {
  return Container(
              ...
              GestureDetector(
                onTap: () {
                  Navigator.of(context).push(
                    PageTransition(
                      child: const ContestDetailsScreen(),
